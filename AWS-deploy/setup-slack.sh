...
# 檢查是否已有配置
CONFIG_FILE="/opt/globalping-checker/slack-config.env"
...
echo "========================================"
echo ""
echo "配置文件: slack-config.env"
echo ""
echo "下一步："
echo "  1. 將配置上傳到 EC2:"
echo "     scp slack-config.env ec2-user@YOUR_IP:/tmp/"
echo "     ssh ec2-user@YOUR_IP 'sudo mv /tmp/slack-config.env /opt/globalping-checker/'"
echo ""
echo "  2. 或使用部署腳本自動上傳"
echo ""
