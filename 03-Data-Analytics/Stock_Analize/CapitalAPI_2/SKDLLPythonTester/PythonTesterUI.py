...
class Order(ttk.LabelFrame):
    def __init__(self, parent):
        ...
        # === 內期未平倉查詢 groupBox31 ===
        self.groupBox31 = ttk.LabelFrame(self.TabPage23, text="內期未平倉查詢")
        self.groupBox31.grid(row=1, column=0, sticky="ew", padx=10, pady=10)

        # 包一層 Frame 來手動調整左邊距
        self.frameInner31 = ttk.Frame(self.groupBox31)
        self.frameInner31.grid(row=0, column=0, padx=6, pady=2, sticky="w")  # 🔧 調整 padx 讓它左邊對齊 groupBox30

        ttk.Label(self.frameInner31, text='格式').grid(row=0, column=0, padx=5, pady=5)

        boxTypeboxGetOpenInterestGWFormat = ["0:預設"]
        self.boxGetOpenInterestGWFormat = ttk.Combobox(self.frameInner31, values=boxTypeboxGetOpenInterestGWFormat)
        self.boxGetOpenInterestGWFormat.grid(row=1, column=0, padx=5, pady=2, sticky="w")

        self.btnGetOpenInterestGW = ttk.Button(self.frameInner31, text="btnGetOpenInterestGW")
        self.btnGetOpenInterestGW.grid(row=1, column=1, padx=5, pady=2, sticky="w")

        # === 國內權益數查詢 groupBox34 ===
        self.groupBox34 = ttk.LabelFrame(self.TabPage23, text="國內權益數查詢")
        self.groupBox34.grid(row=2, column=0, sticky="ew", padx=10, pady=10)

        # 包一層 Frame 來手動調整左邊距
        self.frameInner32 = ttk.Frame(self.groupBox34)
        self.frameInner32.grid(row=1, column=0, padx=6, pady=2, sticky="w")  # 🔧 調整 padx 讓它左邊對齊 groupBox30

        ttk.Label(self.frameInner32, text='幣別').grid(row=0, column=0, padx=5, pady=5)

        boxTypeGetFutureRights_CoinType = ["0:全幣別", "1:基幣(台幣TWD)", "2:人民幣RMB"]

        self.boxGetFutureRights_CoinType = ttk.Combobox(self.frameInner32, values=boxTypeGetFutureRights_CoinType)
        self.boxGetFutureRights_CoinType.grid(row=1, column=0, padx=5, pady=2, sticky="w")

        self.btnGetFutureRights = ttk.Button(self.frameInner32, text="btnGetFutureRights")
        self.btnGetFutureRights.grid(row=1, column=1, padx=5, pady=2, sticky="w")

        # === 海期未平倉查詢 groupBox32 ===
        self.groupBox32 = ttk.LabelFrame(self.TabPage24, text="海期未平倉查詢")
        self.groupBox32.grid(row=1, column=0, sticky="ew", padx=10, pady=10)

        # 包一層 Frame 來手動調整左邊距
        self.frameInner31 = ttk.Frame(self.groupBox32)
        self.frameInner31.grid(row=0, column=0, padx=6, pady=2, sticky="w")  # 🔧 調整 padx 讓它左邊對齊 groupBox30

        ttk.Label(self.frameInner31, text='格式').grid(row=0, column=0, padx=5, pady=5)

        boxTypeboxGetOFOpenInterestGW = ["1:彙總"]
        self.boxGetOFOpenInterestGW = ttk.Combobox(self.frameInner31, values=boxTypeboxGetOFOpenInterestGW)
        self.boxGetOFOpenInterestGW.grid(row=1, column=0, padx=5, pady=2, sticky="w")

        self.btnGetOFOpenInterestGW = ttk.Button(self.frameInner31, text="btnGetOFOpenInterestGW")
        self.btnGetOFOpenInterestGW.grid(row=1, column=1, padx=5, pady=2, sticky="w")

        # === 海外權益數查詢 groupBox35 ===
        self.groupBox35 = ttk.LabelFrame(self.TabPage24, text="海外權益數查詢")
        self.groupBox35.grid(row=2, column=0, sticky="ew", padx=10, pady=10)

        # 包一層 Frame 來手動調整左邊距
        self.frameInner33 = ttk.Frame(self.groupBox35)
        self.frameInner33.grid(row=0, column=0, padx=6, pady=2, sticky="w") # 🔧 調整 padx 讓它左邊對齊 groupBox30

        ttk.Label(self.frameInner33, text='幣別').grid(row=0, column=0, padx=5, pady=5)

        boxTypeGetOFFutureRights_CoinType = ["0:全幣別"]

        self.boxTypeGetOFFutureRights_CoinType = ttk.Combobox(self.frameInner33, values=boxTypeGetOFFutureRights_CoinType)
        self.boxTypeGetOFFutureRights_CoinType.grid(row=1, column=0, padx=5, pady=2, sticky="w")

        self.btnGetOFFutureRights = ttk.Button(self.frameInner33, text="btnGetOFFutureRights")
        self.btnGetOFFutureRights.grid(row=1, column=1, padx=5, pady=2, sticky="w")

        # === 證券即時庫存查詢 groupBox33 ===
        self.groupBox33 = ttk.LabelFrame(self.TabPage22, text="證券即時庫存查詢")
        self.groupBox33.grid(row=0, column=0, sticky="ew", padx=10, pady=10)

        self.btnGetRealBalanceReport = ttk.Button(self.groupBox33, text="btnGetRealBalanceReport")
        self.btnGetRealBalanceReport.grid(row=1, column=6, padx=5, pady=2)
