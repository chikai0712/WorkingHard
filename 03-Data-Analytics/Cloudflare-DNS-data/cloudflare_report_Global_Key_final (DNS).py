...
#   1. api_key + email（Global API Key，舊式）

#   2. api_token（API Token，建議使用，權限：Zone:Read + DNS Analytics:Read）

# account_id 可留空（None），留空時會查詢該認證下所有可存取的 zones
...
accounts = [
...

    {
        ...
        "email": "infa-tech@568win.com",

        "api_token": "6f923fa97c6acda87007236d95ee5b6007863",
