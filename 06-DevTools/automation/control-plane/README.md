...
- `02-Cloud-Deploy/automation/cicd/pipeline.sh`
- `02-Cloud-Deploy/automation/release/release.sh status|deploy`
- `02-Cloud-Deploy/automation/iac/terraform_wrapper.sh . plan|apply-dry-run`
- `08-Database/DB-Automation/backup-recovery/verify_backup.sh`
- `08-Database/DB-Automation/migration/migrate.sh info`
